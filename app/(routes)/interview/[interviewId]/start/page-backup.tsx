...
//             console.log("Creating Akool session...");
...
//             console.log("Akool session response:", result.data);
            
//             const credentials = result?.data?.data?.credentials;

//             if(!credentials){
//                 console.error("No credentials found in response:", result.data);
//                 throw new Error(`No credentials returned from Akool. Response: ${JSON.stringify(result.data)}`);
//             }
